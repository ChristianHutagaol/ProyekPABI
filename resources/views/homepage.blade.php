    ...
    <div class="swiper-container">
        <div>
            ...
            <section class="islands">
                <img
                    src="{{ asset('frontend/assets/img/mobile-bg.png') }}"
                    alt=""
                    class="islands__bg"
                />
...
<section id="gallery">
    <div><img src="images/bali1.jpeg" /> </div>
    <div><img src="images/bali2.jpeg" /> </div>
    <div><img src="images/bali3.jpeg" /> </div>
    <div><img src="images/bali4.jpeg" /> </div>

</section>
<section class="video-container">
    <div class="video-overlay"></div>
    <video autoplay muted loop class="video">
        <source src="video/bali1.mp4" type="video/mp4" />
    </video>
</section>

<section class="abuabu" id="blog">
    <h1 class = "ye"> Hal-hal yang dapat dilakukan </h1>
    <div class="layar-dalam blog">
        <div class ="yo">
            <img src="images/atr1.jpeg" />
            
            <p> Mencoba olahraga air yang banyak digemari, yaitu surfing. Tetap hati-hati karena ombak besar bisa datang kapan saja
            </p>
        </div>
        <div class ="yo">
            <img src="images/atr2.jpeg" />
            
            <p> Bermain dan membangun istana pasir menjadi kegiatan yang menyenangkan. Bisa dilakukan bersama si kecil untuk melatih sensoriknya
            </p>
        </div>
        <div class ="yo">
            <img src="images/atr3.jpeg" />
          
            <p> Coba buat api unggun saat kamu bermalam di sana. Menikmati angin malam dan suara ombak yang syahdu, nikmat banget!
            </p>
        </div>
        <div class ="yo">
            <img src="images/atr4.jpeg" />
           
            <p> Berdoa
            </p>
        </div>
        <div class ="yo">
            <img src="images/atr5.jpeg" />
            
            <p> Berdoa
            </p>
        </div>
        <div class ="yo">
            <img src="images/atr6.jpeg" />
            
            <p> Menikmati keindahan bawah laut dengan snorkeling seperti ini tentunya akan membuatmu jadi lebih mengenal alam.
            </p>
        </div>
    </div>
